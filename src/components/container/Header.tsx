import { Accessor, children, createSignal, JSX, Show, Suspense } from "solid-js"
...
export function Header(props: HeaderProps) {
    ...
    return (
        <div class={`z-50 fixed top-0 left-0 w-screen h-header-mobile md:h-header bg-white ${props.toggle() ? '' : 'shadow-md md:shadow-none'} ${props.className ?? ''}`}>
          <div
          ...
          >
              ...
              <Text className="font-bold" as="h1">{admin.selectedLabel}</Text>
          </div>
          <div
              class="hidden md:flex items-center h-full w-full py-5 pl-9-5 pr-10"
          >
