...
export default function MatchCard({
  ...
  return (
    <a
      href={`/match/${id}`}
      class="w-full max-w-[930px] bg-white/80 dark:bg-gray-800/70 backdrop-blur-md border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-6 transition-all flex flex-col md:flex-row justify-between gap-6"
    >
      {/* Left: Players */}
      <div class="flex-1">
        <h2 class="text-gray-900 dark:text-white font-semibold text-lg mb-3">
          Players
        </h2>
      ...
      {/* Right: Match Info */}
      <div class="flex flex-col justify-center gap-3 text-sm text-gray-800 dark:text-gray-200 min-w-sidebar">
