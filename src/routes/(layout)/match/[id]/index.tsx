...
export default function MatchDetail() {
  ...
  return (
    <>
      ...
      <div class="min-h-screen bg-linear-to-br from-gray-100 to-white dark:from-gray-900 dark:to-gray-800 p-6 flex flex-col items-center">
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-col-1 sm:grid-cols-2 gap-4">
              <Index each={match()?.match_players}>
                {(match_player) => (
                  <a
                    href={`/player/${match_player().player.id}`}
                    class="bg-gray-100 dark:bg-gray-700 rounded-lg p-3 text-sm shadow-sm text-gray-800 dark:text-gray-100"
                  >
                    <div class="font-medium">{match_player().player.name}</div>
                    <div class="text-gray-500 dark:text-gray-400 text-xs">
                      @{match_player().player.username}
                    </div>
                  </a>
                )}
              </Index>
          ...
          <div class="space-y-3 text-sm text-gray-700 dark:text-gray-300">
            ...
            <div class="flex gap-2">
              ...
              <span
                ...
                title={match()?.parlour?.address}
              >
                {match()?.parlour?.address}
              </span>
            </div>
            <div class="flex gap-2">
            ...
            <div class="flex gap-2">
              ...
              <span>{writeDate(match()?.playing_at)}</span>
            </div>
            <div class="flex gap-2">
