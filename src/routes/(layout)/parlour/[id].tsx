...
export default function ParlourDetail() {
  ...
  return (
    <>
      ...
      <div class="min-h-screen bg-gradient-to-br from-gray-100 to-white dark:from-gray-900 dark:to-gray-800 p-6 flex justify-center">
        <div class="w-full  max-w-[930px] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg rounded-2xl p-8 space-y-6">
          ...
          {/* Header */}
          <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{parlour()?.name}</h1>
          </div>
