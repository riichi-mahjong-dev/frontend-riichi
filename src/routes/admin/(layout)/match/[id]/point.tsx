...
export default function PointMatchPage() {
  ...
  const { fields, handleSubmit } = useForm(
    ...
    {
      score_player_1: [isNumber()],
      score_player_2: [isNumber()],
      score_player_3: [isNumber()],
      score_player_4: [isNumber()],
      match_player_1: [isNumber()],
      match_player_2: [isNumber()],
      match_player_3: [isNumber()],
      match_player_4: [isNumber()],
    },
  );
  ...
  return (
    <div class="bg-white p-8 rounded">
      <h2 class="text-xl font-bold mb-10">Input Point Match ID {params.id}</h2>
      <form
      ...
      >
        ...
        <Input
          ...
          onInput={(e) =>
            fields["score_player_1"].setValue(Number(e.currentTarget.value))
          }
          type="number"
          placeholder="Point..."
        ...
        <Input
          ...
          onInput={(e) =>
            fields["score_player_2"].setValue(Number(e.currentTarget.value))
          }
          type="number"
          placeholder="Point..."
          error={fields["score_player_1"].error()}
        ...
        <Input
          ...
          onInput={(e) =>
            fields["score_player_3"].setValue(Number(e.currentTarget.value))
          }
          type="number"
          placeholder="Point..."
          error={fields["score_player_1"].error()}
        ...
        <Input
          ...
          onInput={(e) =>
            fields["score_player_4"].setValue(Number(e.currentTarget.value))
          }
          type="number"
          placeholder="Point..."
          error={fields["score_player_1"].error()}
