...
export const getAdmins = query(
  async (paginateRequest: PaginateRequest): Promise<AdminResponse> => {
    "use server";
...
export const createAdmin = action(
  async (body: AdminRequest): Promise<Admin> => {
    "use server";
...
export const updateAdmin = action(
  async (id: number, body: AdminRequest): Promise<Admin> => {
    "use server";
...
export const updatePasswordAdmin = action(
